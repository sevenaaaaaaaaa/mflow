...
| **Tools 工具页** | `1-3 Content Gen/Page Gen/Pages/Tools/{lang}/*.json`（composite-v2） | `compositePage` | [`SOP-Lovart-Tools-Sanity-发布统合指南.md`](../lovart-tools-sanity-publish/SOP-Lovart-Tools-Sanity-发布统合指南.md) | [`lovart-tools-sanity-publish/`](../lovart-tools-sanity-publish/) |
...
### Tools（composite-v2 · 正式源）

```bash
node scripts/sync-tools-from-production.js   # 换设备 / 首次
