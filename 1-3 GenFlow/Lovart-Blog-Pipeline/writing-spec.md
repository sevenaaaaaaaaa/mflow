...
6. **Image appendix** — all IMAGE PLACEHOLDER blocks listed at end with descriptions
...
Pool: `1-Project/Lovart-Blog-Pipeline/Lovart-Blogs/Cover Url 随机调取.md` (56 unique URLs) <!-- TODO: 旧 Lovart/Sanity Blog/ 已删除，封面池需放到此新位置 -->
...
If needing Feishu wiki integration: `1-Project/Wordpress/Feishu-Knowledge-Base/` <!-- TODO: 该目录在重构中已删除，如仍需请确认新落点 -->
